"""
This module contains the FastAPI application instance for the chatbot management API. It includes the chatbot router and configures CORS middleware.
"""
# pylint: disable=E0401
from fastapi import FastAPI
from fastapi.middleware.cors import CORSMiddleware
from fastapi.middleware.trustedhost import TrustedHostMiddleware
from api.endpoints.v1.chatbot_management import router as chatbot_router
...
def chatbot_management_app() -> FastAPI:
    """
    ...
    app = FastAPI(
        ...
        description="API for managing chatbot functionality.",
        version="1.0.0",
    )
    ...
    # Include chatbot management router
