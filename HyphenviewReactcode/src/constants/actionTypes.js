...
export const GET_DRILL_DOWN_DATA_VALUE = "GET_DRILL_DOWN_DATA_VALUE";

export const EXPORT_EXCEL_REPORT = "EXPORT_EXCEL_REPORT";
export const EXPORT_PDF_REPORT = "EXPORT_PDF_REPORT";
export const EXPORT_CSV_REPORT = "EXPORT_CSV_REPORT";
export const DEFAULT_EXPORT_CSV_REPORT = "DEFAULT_EXPORT_CSV_REPORT";
export const FILTER_DATA_REPORT_BY_ID = "FILTER_DATA_REPORT_BY_ID";
// export const GET_UNIQUE_COLUMN_VALUE = "GET_UNIQUE_COLUMN_VALUE";
export const FILTER_DATA_REPORT_BY_ID_DRILL = "FILTER_DATA_REPORT_BY_ID_DRILL";
export const GET_COLUMN_DRILL_DOWN_DATA = "GET_COLUMN_DRILL_DOWN_DATA";
...
export const FETCH_NAV_ICON = "FETCH_NAV_ICON";
export const FETCH_LOGIN_LOGO = "FETCH_LOGIN_LOGO";
export const FETCH_PDF_LOGO = "FETCH_PDF_LOGO";
export const RESET_PASSWORD_NEW = "RESET_PASSWORD_NEW";
export const GET_REPORT_DETAIL_BASEON_GROUP_ID_REPORTS = "GET_REPORT_DETAIL_BASEON_GROUP_ID_REPORTS";